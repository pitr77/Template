 ...
 * @since 1.0.0
 */
class Musical_Vibe_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'musical_vibe';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'musical-vibe' ), $i ),
...
// Initialize.
$musical_vibe_footer_widgets = new Musical_Vibe_Footer_Widgets();
